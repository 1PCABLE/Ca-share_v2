...
(cree par 1PCABLE#6262)
    ...
    itemID       = Write.Input("[Ca-share]Video Link > ", Colors.red_to_blue, interval=0.0001)
    amount       = Write.Input("[Ca-share]Amount (0=inf) > ", Colors.red_to_blue, interval=0.0001)
    NThread      = Write.Input("[Ca-share]Thread Amount > ", Colors.red_to_blue, interval=0.0001)
    
    if Title("Proy Scrapper X-Proxy by DOS ARGENTA") == True:
        Debug = Write.Input("Debug Fails [y/n] ? > ", Colors.red_to_blue, interval=0.0001)
